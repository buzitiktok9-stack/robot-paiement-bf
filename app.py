...
app = Flask(__name__)
groq_client = Groq(api_key="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")
...
def extract_text_from_image(image_b64: str, media_type: str = "image/jpeg") -> str:
    """Utilise Groq Vision pour extraire le texte d'une image de paiement."""
...
def verify():
    ...
    # Si image fournie, extraire le texte via Groq Vision
